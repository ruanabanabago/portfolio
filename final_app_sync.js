...
const endIdx = appjs.indexOf('};', appjs.indexOf('de: {')) + 2;

if (startIdx !== -1 && endIdx !== -1) {
    appjs = appjs.slice(0, startIdx) + fullTranslations + appjs.slice(endIdx);
    fs.writeFileSync('app.js', appjs);
    console.log('Final app.js translation sync complete.');
} else {
    console.log('Could not find translation block in app.js');
}
